...
public class Robot {
    ...
    final int FRIENDLY_HQ_MIN_INDEX = 30;
    final int FRIENDLY_HQ_MAX_INDEX = 39;
    ...
    public void addHQLoc(MapLocation loc, Team team) throws GameActionException {
        int teamNum = 0;
        if (!team.isPlayer()) {
            teamNum = 1;
        }

        int locCode = teamNum * 10000 + locToInt(loc);
        int firstHoleIndex = 0;
